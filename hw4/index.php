...
$works = [
    [
        ...
        "description" => "Координирование и организация правильной работы поваров и кухонных работников, 
        закупка продуктов, проверка блюда перед подачей,  участие в разработке меню и новых рецептов.
        Управления коллективом в отсутствии шеф-повара."
    ],
    [
        "name" => "Повар",
        "dateStart" => "Июль 2007",
        "dateEnd" => "Февраль 2020",
        "description" => "Готовит супы, вторые блюда, другую пищу. 
        Знает, как правильно хранить продукты, готовит разные блюда по рецептам и умеет оформлять приготовленное.
    ...
    [
        ...
        "dateStart" => "Март 2005",
        "dateEnd" => "Июль 2007",
        "description" => "Выполняет работы по обработке, сборке и починке металлических изделий автомобилей, 
        деталей и систем автомобильной техники, техническому обслуживанию и ремонту автотранспортных средств, 
        проведению контроля технического состояния автомобиля." 
    ]
]
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
            ...
            <div class="w3-container">
                ...
                <h6 class="w3-text-teal">
                    ...
                    <?=$works[$i]['dateStart'];?> -
                    <?php if ($i == 0): ?>
                    <span class="w3-tag w3-teal w3-round"><?=$works[$i]['dateEnd'];?>
                </span>
                <?php else: ?>
                    <?=$works[$i]['dateEnd'];?>
                    <?php endif?>
